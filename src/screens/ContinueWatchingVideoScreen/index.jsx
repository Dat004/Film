        ...
        {data.map((item) => (
          ...
          >
            <Link to={`/phim/${item.slug}`}>
              <section className="w-[100%] group/cards relative h-0 leading-0 pb-[140%] mb-[8px]">
                ...
                <div className="opacity-0 group-hover/cards:opacity-100 flex items-center justify-center transition-opacity duration-200 absolute inset-0 z-10 backdrop-blur-[10px]">
                  ...
                  <div className="absolute top-[2.5%] right-[2.5%] flex items-center justify-center size-[25px] bg-bg-white rounded-[50%]">
                    <Button
