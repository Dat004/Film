...
import { RiCloseLargeFill, RiSendPlane2Fill } from "react-icons/ri";
import { ChatMessage } from "./ChatMessage";
import { sendMessage } from "@/features/watch-party/services/watch-party-service";
...
export function ChatPanel({
  ...
  return (
    <div 
      ...
      style={{ 
        width: isChatOpen ? (isMobile ? "100%" : typeof chatWidth === "number" ? `${chatWidth}px` : chatWidth) : "0px", 
