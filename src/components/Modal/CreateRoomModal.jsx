...
function CreateRoomModal({ 
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <Modal isShowModal={isOpen} onClose={onClose}>
          <motion.div
            variants={variants}
            initial="hide"
            animate="show"
          ...
          >
            <div className="modal-panel-surface mx-auto w-[420px] mdm:w-[85%] kdm:w-[90%] rounded-[12px] overflow-hidden bg-bg-sidebar border border-bd-filed-form-color p-[24px]">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="relative flex w-[100%] mb-[20px]">
                  <input
                    name="roomPassword"
                    placeholder="Mật khẩu phòng (không bắt buộc)..."
                    className="p-[14px] pr-[42px] h-[46px] text-[14px] text-primary bg-bg-field border border-bd-filed-form-color focus:border-[var(--primary-color)] rounded-[8px] w-[100%] outline-none transition-colors"
